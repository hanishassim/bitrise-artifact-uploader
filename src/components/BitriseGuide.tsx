        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3 rounded-lg bg-muted/30 p-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-foreground">Where to get API Token?</p>
              <p className="text-xs text-muted-foreground mt-1">
                Bitrise → Account Settings → Security (left panel) → Personal access tokens → Create or edit token
              </p>
              <a
